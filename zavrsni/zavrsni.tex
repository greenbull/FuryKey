...
\zahvala{Zahvaljujem se prof. dr. sc. Vladi Glaviniću na mentorstvu, prenesenom znanju i korisnim savjetima pruženim pri pisanju ovog rada. 
\\Posebno se zahvaljujem svojoj obitelji na velikoj podršci tijekom svih ovih godina.}
...
\item položaj pametnog uređaja: horizontalno \engl{landscape}, vertikalno \engl{portrait}
\end{itemize}
Zavisne varijable:
\begin{itemize}
...
\captionof{table}{Grafički prikaz rezultata za FuryKey1}
...
\captionof{table}{Grafički prikaz rezultata za FuryKey2}
...
\kljucnerijeci{tipkovnica, QWERTY, eksperiment, Fittsov zakon, genetski algoritam, jezik}
\end{sazetak}
...
\keywords{keyboard, QWERTY, experiment, Fitts' law, genetic algorithm, language}
\end{abstract}
